...
const novela1 = new MiClase("Warlok In The Magus World", 999999, "./asset/img/wool.jpeg", ["acción", "aventura", "fantasía", "artes marciales"], "#",3);
arNovel.push(novela1);


const novela2 = new MiClase("Warlok In The Magus World", 999000, "./asset/img/harrypother.jpeg", ["acción", "fantasía", "artes marciales"], "#",2);
arNovel.push(novela2);
const novela3 = new MiClase("Warlok In The Magus World", 990000, "./asset/img/reinosolvidados.jpeg", ["acción", "aventura", "artes marciales"], "#",3);
arNovel.push(novela3);
const novela4 = new MiClase("Warlok In The Magus World", 900000, "./asset/img/warlockofthemagusworld.jpeg", ["acción", "aventura", "fantasía"], "#",4);
arNovel.push(novela4);
const novela5 = new MiClase("Warlok In The Magus World", 800000, "./asset/img/OIP.jpeg", ["aventura", "fantasía", "artes marciales"], "#",5);
arNovel.push(novela5);
const novela6 = new MiClase("Warlok In The Magus World", 700000, "./asset/img/silmarillion.jpeg", ["acción", "artes marciales"], "#",6);
arNovel.push(novela6);
const novela7 = new MiClase("Warlok In The Magus World", 600000, "./asset/img/StarOdyssey.JPEG", ["fantasía", "artes marciales"], "#",7);
arNovel.push(novela7);
const novela8 = new MiClase("Warlok In The Magus World", 500000, "./asset/img/OIP.jpeg", ["artes marciales"], "#",8);
arNovel.push(novela8);
const novela9 = new MiClase("Warlok In The Magus World", 400000, "./asset/img/OIP.jpeg", ["acción", "aventura", "fantasía", "artes marciales"], "#",9);
arNovel.push(novela9);
const novela10 = new MiClase("Warlok In The Magus World", 300000, "./asset/img/OIP.jpeg", ["acción"], "#",10);
arNovel.push(novela10);


// Ordenar las novelas en función de las visitas
const novelasOrdenadas = arNovel.sort((novelaA, novelaB) => novelaB.visitas - novelaA.visitas);
const novelasSemana = arNovel.sort((novelaA, novelaB) => novelaB.visitasSemana - novelaA.visitasSemana)
  ...
  for (let i = 0; i < 4; i++) {
    const enlaceUnoHTML = `
      <a href="${novelasOrdenadas[i].url}" class="carusel">
        <img src="${novelasOrdenadas[i].img}" class="img_blockCont" alt="algo" id="imgtop${i + 5}">
      </a>`;

    const enlaceDosHTML = `
      <a href="${novelasOrdenadas[i+3].url}" class="carusel">
        <img src="${novelasOrdenadas[i+3].img}" class="img_blockCont" alt="algo" id="imgtop${i + 5}">
      </a>`;
